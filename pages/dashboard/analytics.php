                ...
                <div class="income-inf-row row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-text">
                                    ...
                                    <div class="card-price"><span>EG. <?php echo htmlspecialchars($totalCredit) ?></span></div>
                                </div>
                                <div class="card-icon">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-text">
                                    ...
                                    <div class="card-price"><span>EG. <?php echo htmlspecialchars($totalDebit) ?></span></div>
                                </div>
                                <div class="card-icon">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-text">
                                    ...
                                    <div class="card-price"><span>EG. <?php echo htmlspecialchars($totalCredit + $totalDebit) ?></span></div>
                                </div>
                                <div class="card-icon">
                    ...
                    <div class="col-income">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-text">
                                    <div class="card-span"><span style="color: rgb(54, 185, 204);">I/E Ratio</span></div>
