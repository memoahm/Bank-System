...
$receiver_balance = 
        mysqli_fetch_assoc(mysqli_query($conn, "SELECT Balance FROM balance WHERE AccNo = '$receiver_accNo'"))['Balance'];
...
$insert_transaction = "INSERT INTO transactions (Sender, Receiver, Amount, Remarks, SenBalance, RecBalance) 
VALUES ('$sender_accNo', '$receiver_accNo', '$amount', '$remarks', '$curr_sen_balance', '$curr_rec_balance')";
